...
#define STRING_CONFIG_H_AUTHOR "(CR10S_BMG, exp config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "DIY CR10S SGENL BMG"
...
#define TEMP_BED_RESIDENCY_TIME  7  // (seconds) Time to wait for bed to "settle" in M190
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 2500, 2500, 100, 100 }
...
#define LCD_BED_LEVELING
  ...
  #define MESH_EDIT_Z_STEP  0.050 // (mm) Step size while manually probing Z axis.
